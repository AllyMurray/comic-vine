...
function testExports() {
  console.log('Testing in-memory-store package.json exports...');
  ...
  try {
    ...
    console.log('✅ in-memory-store exports validation test passed');
    return true;
  } catch (error) {
    console.error(
      '❌ in-memory-store exports validation test failed:',
      error.message,
    );
    return false;
  }
