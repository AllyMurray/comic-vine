...
Version 3 supports Node.js 22 and newer. CI tests Node.js 22 and 24 LTS. Node.js 20 reached end of life on
30 April 2026 and is no longer supported. Upgrade to a supported LTS release
before moving from SDK v2 to v3.
