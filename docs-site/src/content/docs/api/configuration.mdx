...
:::note[Need deeper store documentation?]
For store internals, custom store implementations, and advanced toolkit options, see the [HTTP Client Toolkit documentation](https://allymurray.github.io/http-client-toolkit/).
:::
