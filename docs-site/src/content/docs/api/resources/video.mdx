...
:::caution[Omitted API fields]
The `savedTime` and `videoShow` fields from the Comic Vine API are not included in this SDK. An exhaustive scan of all 3,119 videos in the API confirmed these fields are always `null` and have no discernible type.
:::
